...
export const T = {
  ko: {
    ...
    role: "AI 크리에이터",
    bio1: "결국 현실은 하드웨어 세상이니까….",
    bio2: "어디까지 되나 보자 | 지금 바로 저점매수 하세요 ✌🏻",
    headline1: "바이브코딩과 ",
    headlineEm: "피지컬 AI",
    headline2: "가",
    headline3: "만났을 때 👾🤖",
  ...
  en: {
    ...
    role: "AI Creator",
    bio1: "Because in the end, reality runs on hardware….",
    bio2: "Let's see how far this goes | Buy the dip ✌🏻",
    headline1: "When vibe coding ",
    headlineEm: "meets physical AI",
    headline2: "",
    headline3: "👾🤖",
